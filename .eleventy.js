...
module.exports = function (eleventyConfig) {
    ...
    eleventyConfig.addFilter("postDate", (dateObj) => {
        return DateTime.fromJSDate(dateObj).setLocale('en-GB').toLocaleString(DateTime.DATE_MED)
    })

    eleventyConfig.addFilter("postDateDay", (dateObj) => {
        return DateTime.fromJSDate(dateObj).setLocale('en-GB').toLocaleString({ weekday: 'short', month: 'short', day: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' }); //=> 'Thu, Apr 20, 11:27 AM'
    });
